            ...
            int32_t event_id, void* event_data)
{
    ...
    */
        ...
        if(strcmp(RELAY_OUTPUT_SET,topic))
        {

        }
        else if(strcmp(RELAY_INPUT_GET,topic))
        {
            
        }
        else if(strcmp(RELAY_OUTPUT_GET,topic))
        {
...
esp_err_t user_mqtt_start(void)
{
    ...
    {
        mqtt_tca_exchange_queue = xQueueCreate(5,sizeof(uint16_t));
